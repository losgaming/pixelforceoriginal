...
inline half2 FetchCurrOcclusionDepth( const half2 aUV )
{
						...
						out half out_temporal_AO )
{
		  ...
		  ( reproj_screenPos.y > 1.0 ) ) == false )
	{
		...
		half2 cTL = FetchCurrOcclusionDepth( half2( -vd, -vd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cTR = FetchCurrOcclusionDepth( half2( +vd, -vd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cBL = FetchCurrOcclusionDepth( half2( -vd, +vd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cBR = FetchCurrOcclusionDepth( half2( +vd, +vd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		...
		const half vd = 1.0;
		half2 cT = FetchCurrOcclusionDepth( half2(   0, -vd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cL = FetchCurrOcclusionDepth( half2( -vd,   0 ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cR = FetchCurrOcclusionDepth( half2( +vd,   0 ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cB = FetchCurrOcclusionDepth( half2(   0, +vd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		...
		const half dd = 1.55;
		half2 cTL = FetchCurrOcclusionDepth( half2( -dd, -dd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cTR = FetchCurrOcclusionDepth( half2( +dd, -dd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cBL = FetchCurrOcclusionDepth( half2( -dd, +dd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
		half2 cBR = FetchCurrOcclusionDepth( half2( +dd, +dd ) * _AO_CurrOcclusionDepth_TexelSize.xy + aScreenPos );
